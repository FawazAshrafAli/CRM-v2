...
class Deal(models.Model):
    ...
    user_responsible = models.ForeignKey(User, on_delete=models.PROTECT, blank=True, null=True)
    ...
    record_owner = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, related_name="record_owner")
