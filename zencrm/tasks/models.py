...
class Task(models.Model):
    ...
    # Task Owner
    record_owner = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, null=True, related_name="task_owner")

    # Persmission
    task_visibility = models.CharField(max_length=150, blank=True, null=True)

    created_by = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, null=True, related_name="task_created_by")

    #  Creation and Updation Details
    organization_id = models.CharField(max_length=150)
